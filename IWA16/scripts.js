const MONTHS = [
  ...
  const [date, timeAsArray] = races[races.length - 1];
...
document.querySelector('#' + NM372[2]).appendChild(createHtml(NM372));
document.querySelector('#' + SV782[2]).appendChild(createHtml(SV782));
